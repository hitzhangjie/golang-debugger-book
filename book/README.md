...
大家好，我是张杰，目前在腾讯担任高级后台开发工程师，长期从事大规模业务的后台、基础技术、系统架构相关工作，方向包括微服务框架、微服务架构、可观测性、工程效能、DevOps、测试等等。我参与了腾讯微服务框架 [Tencent/trpc](https://github.com/Tencent/trpc) 的设计与实现，在团队内推动过工程效能（工程规范、代码质量与相关工具建设）相关工作，主导过多个核心系统的架构设计与上线筹备工作。这些经历不仅让我深入了解各类业务挑战与解决方案，也为我持续磨练技术、实现个人成长提供了宝贵机会。

做工程效能，你会发现整个软件研发工作流的各个环节都得被度量、被量化，才能去分析、优化；做架构，也常常是为了让不可见的东西变得可见，才能观测、治理；做分布式系统，需要 tracing+metrics+logging 把调用链全景展开，才能看清系统怎么运行的 …… 最终，再大的业务、产品，也得落到一个个进程里头。那又该如何进一步地观测一个进程呢？对效率的追求，让我渴望有双“上帝之眼”，能看清问题本质，这本书就是想把进程调试领域沉淀了几十年的精髓与智慧，分享给大家—— “一个聪明人会如何进行调试”。
