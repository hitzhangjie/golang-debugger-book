...
大家好，我是张杰，目前在腾讯担任高级后台开发工程师，长期从事大规模业务的后台、基础技术、系统架构相关工作，方向包括微服务框架、微服务架构、可观测性、工程效能、DevOps、测试等等。我参与了腾讯微服务框架 [Tencent/trpc](https://github.com/Tencent/trpc) 的设计与实现，在团队内推动改善工程效能，主导过多个核心系统的设计实现与上线筹备。这些经历除了为我沉淀技术提供了宝贵的锻炼机会，也让我对不同场景面临的挑战有了更广泛深入的理解，“如果不能跟踪、观测、量化问题，就无法做出进一步的优化治理”。

工程效能，要将研发工作流的各个环节进行度量，才能去分析优化；架构设计，要将系统中不可见的东西变得可见，才能观测治理；分布式+微服务，要通过可观测性技术展开调用全景，才能理解系统的运转情况 …… 自顶向下看，最终一个业务产品体量再大，也得落到一个个进程里头。性能分析、故障排查、根因分析，即便是了解系统如何运行，你最终要围绕着一个个进程展开。这是我理解的从高层到落地，DEBUG能力在不同场景的差异与共通之处。

我其实一直对技术细节很感兴趣，技术细节对我来说不是琐碎，而是确定性。一次成功的Linux内核、Go运行时代码探秘、调试跟踪过程，能一扫积压心头多天的困惑，那种满足感以及对日后解决问题的帮助促进，是难以言表的。我也很确定地知道，有些人只想了解大概，当他们不确定或者理不清楚时，就要寻求更有沉淀的人来帮助。而我刚好愿意成为那种求知欲比较强的人。在这个过程中，也经常会产生一种欲望，渴望有双“上帝之眼”能更高效地看清问题本质，以及追求“如何更聪明地进行调试”。
...
我理解，调试器领域也确实沉淀了一些值得拿出来分享的东西，比如DWARF标准演进以支持更多语言特性，调试器架构演进以支持更多调试场景，如与IDE集成、跨平台调试、远程调试等，以及录制回放技术（record & replay）以实现确定性调试，等等。这些东西如果只停留在成熟稳定的项目代码中，或者少数几个核心贡献者的大脑里，未免太可惜了。
