...
english:
	rm -rf ./_book
	ln -sf ./1-introduction/README.md ./README.md
	ln -sf ./0-summary/SUMMARY.en_US.md ./SUMMARY.md
	gitbook serve

chinese:
	rm -rf ./_book
	ln -sf ./1-introduction/README.zh_CN.md ./README.md
	ln -sf ./0-summary/SUMMARY.zh_CN.md ./SUMMARY.md
	gitbook serve
